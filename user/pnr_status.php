...
if(isset($_REQUEST["submit"]))
{
	...
	{
		header("location:pnrcheck.php?pnr=$pnr");
        	...
        	<div class="col-lg-offset-1 col-lg-7 well">         
                  ...
                  <h3>Enter PNR No.</h3>
                        ...
                        <label>Enter Your PNR No</label>
                        	<input type="text" name="pnr" class="form-control"  placeholder="PNR No"/></div>
...
<div class="col-lg-3  my-sidebar affix">
            ...
            <div class="list-group">
                    ...
                    <a href="train_enquiry.php" class="list-group-item">Scheduled Cabs
                    </a>
                    <a href="cancel.php" class="list-group-item">Unscheduled Cabs
                    </a>
